...
import java.awt.event.MouseAdapter; // Pake MouseAdapter [cite: 1586-1587]
...
public class ContohMouseListener { 
    ...
    public static void main(String[] args) {
        ...
        MouseAdapter adapter = new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) { // Saat mouse masuk 
                // Saat mouse masuk, ubah warna jadi biru
                panel.setBackground(Color.CYAN);
            }

            @Override
            public void mouseExited(MouseEvent e) { // Saat mouse keluar 
                // Saat mouse keluar, kembalikan warna
                panel.setBackground(Color.LIGHT_GRAY);
            }
            
            @Override
            public void mouseClicked(MouseEvent e) { // Saat diklik 
